...
const Articles = () => {
  return (
    <section className="articles flex flex-col items-center min-[200px] py-10 px-5 bg-very-light-gray lg:items-start lg:px-40 ">
      <h1 className="text-2xl text-dark-blue font-semibold">Latest Articles</h1>
      <div className="articles grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10">
        <Article
          image={currency}
