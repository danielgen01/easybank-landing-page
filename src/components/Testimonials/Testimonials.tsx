...
const Testimonials = () => {
  return (
    <section className="bg-light-grayish-blue min-h-[200px] w-screen py-10 flex flex-col items-center gap-5 lg:items-start lg:px-40">
      ...
      <div className="testimonials flex flex-col lg:flex-row">
        <Testimonial
          icon={icononline}
          text={
